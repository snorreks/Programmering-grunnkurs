package Øving5.Random;/*Oppgave 6.3: RandomMellomToTall
	SKS 18.09.2017	*/
...
class RandomMellomToTall{
	...
	//Les inn data fra brukeren:
		String lest1 = showInputDialog(null,"Skriv inn f�rste tall: ","Nedre grensen", QUESTION_MESSAGE);
		if(lest1 == null){break;}
		int nedre = Integer.parseInt(lest1);

		String lest2 = showInputDialog(null,"Skriv inn siste tall: ","�vre grensen", QUESTION_MESSAGE);
		if(lest2 == null){break;}
