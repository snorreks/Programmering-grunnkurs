public class Oppgaveoversikt{
 	...
 	private int antStud = 30; // økes med 1 for hver ny student
	...
	public int getAntOppgaver(String input){ //antall oppgaver en bestemt har løst
	...
	public void nyOppg(String input, int antall){ //øk antall oppgaver for en bestemt student
				studenter[finnStudNr(input)].økAntOppg(antall);
	}
