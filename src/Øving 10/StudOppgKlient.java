...
class StudOppgKlient{
	public static void main (String[]args){
		...
		while(true){
			...
			String studentSe = (String)showInputDialog(null, "Velg hvilken student du vil se på", "Velg student", QUESTION_MESSAGE, null, henteValg, henteValg[0]);
			if(studentSe == null) break;

			boolean run2 = true;
			while(run2){
				String[] options = new String[]{"Finn student nr","Finn antall oppgaver","Øk oppg for studenten","Registrer flere studenter","Velg student","Cancel"};
				int response = showOptionDialog(null, "Velg oppgave:", "Du ser på studenten: " + studentSe, DEFAULT_OPTION, PLAIN_MESSAGE, null, options, options[0]);
				...
				switch(response){
					...
					case 1:
						...
						break;
					case 2:
						String nyOppgLest = showInputDialog(null,"Skriv inn antall nye oppgaver for studenten: ","Øk oppgaver for studenten ", QUESTION_MESSAGE);
						...
						showMessageDialog(null, studentSe + " har nå " + o.getAntOppgaver(studentSe) + " oppgaver.", "Oppgaver for studenten", QUESTION_MESSAGE);
						break;
					case 3:
  						JPanel p = new JPanel();
