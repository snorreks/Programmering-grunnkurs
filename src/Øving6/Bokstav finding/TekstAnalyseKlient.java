package Øving6.Bokstav/*Oppgave 7.3
	SKS 01.10.2017	*/
...
//Leser inn data fra brukeren:
		...
		String bokstavLest = (showInputDialog(null,"Skriv bokstaven du vil se p�: ","Antall forekomster i tekst nr " + runde, QUESTION_MESSAGE)).toUpperCase();
...
//sjekker om man har skrevet inn en bokstav eller spesialtegn
		if(tekst.findIndeks(bokstav) == 29){
			showMessageDialog(null,"Du har ikke tastet inn en bokstav, s� du vil n� f� antall forekomster av alle spesialtegn i teksten.");
		}
